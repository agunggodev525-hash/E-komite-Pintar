  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white/5 backdrop-blur-xl rounded-3xl p-6 border border-white/10 shadow-[0_20px_50px_rgba(8,_112,_184,_0.07)] flex flex-col justify-between h-full space-y-2 group relative overflow-hidden hover:-translate-y-1 transition-transform duration-300">
          ...
          <p className="text-xs font-semibold text-slate-500 uppercase tracking-widest relative z-10">Total Saldo Komite</p>
          <h3 className="text-3xl font-extrabold tracking-tight bg-gradient-to-br from-emerald-400 to-teal-600 bg-clip-text text-transparent pb-1 relative z-10">{formatRupiah(dummyStats.saldo)}</h3>
          <p className="text-xs font-medium text-slate-400 relative z-10">
        ...
        <div className="bg-white/5 backdrop-blur-xl rounded-3xl p-6 border border-white/10 shadow-[0_20px_50px_rgba(8,_112,_184,_0.07)] flex flex-col justify-between h-full space-y-2 group relative overflow-hidden hover:-translate-y-1 transition-transform duration-300">
          ...
          <p className="text-xs font-semibold text-slate-500 uppercase tracking-widest relative z-10">Total Pengeluaran Bulan Ini</p>
          <h3 className="text-3xl font-extrabold tracking-tight bg-gradient-to-br from-rose-400 to-red-600 bg-clip-text text-transparent pb-1 relative z-10">{formatRupiah(dummyStats.pengeluaranBulanIni)}</h3>
          <p className="text-xs font-medium text-slate-400 relative z-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white/5 backdrop-blur-xl rounded-3xl border border-white/10 shadow-xl overflow-hidden">
          <div className="p-6 border-b border-white/10 bg-slate-900/50">
            <h2 className="text-lg font-bold text-white tracking-tight">5 Pengeluaran Terbesar Bulan Ini</h2>
          </div>
              ...
              <tbody className="divide-y divide-white/5">
                {dummyPengeluaran.map((item) => (
                  <tr key={item.id} className="hover:bg-white/5 transition-colors">
                    ...
                    <td className="px-6 py-4 text-right font-semibold text-rose-400 whitespace-nowrap">{formatRupiah(item.nominal)}</td>
        ...
        <div className="bg-white/5 backdrop-blur-xl rounded-3xl p-6 border border-white/10 shadow-xl flex flex-col items-center justify-center relative overflow-hidden group">
          ...
          <h2 className="text-lg font-bold text-white w-full text-left mb-6 tracking-tight relative z-10">Pemasukan vs Pengeluaran</h2>
          ...
          <div className="relative w-48 h-48 rounded-full flex items-center justify-center shadow-lg" 
            ...
            <div className="w-32 h-32 bg-slate-900 rounded-full flex flex-col items-center justify-center shadow-inner relative z-10">
              <span className="text-xs font-bold text-slate-400 uppercase tracking-wider">Status</span>
              <span className="text-xl font-black text-emerald-400">Surplus</span>
            </div>
            {/* Dark border ring */}
            <div className="absolute inset-0 rounded-full border-4 border-slate-900 opacity-50"></div>
          </div>
          ...
          <div className="w-full mt-8 space-y-3 relative z-10">
            <div className="flex justify-between items-center text-sm">
              <div className="flex items-center gap-2">
                ...
                <span className="font-semibold text-slate-300">Pemasukan (66%)</span>
              </div>
            ...
            <div className="flex justify-between items-center text-sm">
              <div className="flex items-center gap-2">
                ...
                <span className="font-semibold text-slate-300">Pengeluaran (34%)</span>
              </div>
